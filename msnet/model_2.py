...
class MFP(torch.nn.Module):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.kan = KAN([2*512,512,2*512],spline_order=4,grid_size=100)
        # -----------------------------------------------
        self.linear_1 = torch.nn.Linear(8*512,4*512)
        self.linear_2 = torch.nn.Linear(4*512,2*512)
        self.linear_final_1 = torch.nn.Linear(2*512,768)
        self.linear_final_2 = torch.nn.Linear(768,4)
        # -----------------------------------------------
